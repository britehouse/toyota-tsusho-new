...
namespace Toyota.Tsusho.TALO.API.ServiceContracts
{
    ...
    {
        [OperationContract(IsTerminating = false, IsInitiating = true, IsOneWay = false, AsyncPattern = false, Action = "http://www.ttaf.co.za/talo/api/2014/05/IOrderService/Confirm", ProtectionLevel = ProtectionLevel.None)]
