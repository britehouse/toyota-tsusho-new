...
namespace Toyota.Tsusho.API.Testing
{
    ...
    public class ShippingInformationServiceTests
    {
        ...
        {
            ShippingInformationServiceReference.ShippingInformationDataContract request = new ShippingInformationServiceReference.ShippingInformationDataContract()
            {
            ...
            ShippingInformationServiceReference.ShippingInformationServiceClient client = new ShippingInformationServiceReference.ShippingInformationServiceClient();
